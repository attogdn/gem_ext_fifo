...
# Vivado variables
VIV_DESIGN = gem_external_fifo_transceiver
VIV_PRJ_DIR = run
...
export VIVADO_PROJ_NAME := gem_external_fifo_transceiver
export VIVADO_VENDOR := TRANSBIT
export VIVADO_LIBRARY := ethernet
